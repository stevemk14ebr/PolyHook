...
6. **VEH**
  * Description: Intercepts the exception generated by an INT3 breakpoint, removes breakpoint, changes the Instruction pointer to the target whre user can call original function if desired, then restores breakpoint using C++ RAII
